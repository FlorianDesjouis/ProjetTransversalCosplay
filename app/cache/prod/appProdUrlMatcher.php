    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/article')) {
            ...
            if (rtrim($pathinfo, '/') === '/article') {
                ...
                return array (  '_controller' => 'DesguizeBundle\\Controller\\ArticleController::indexAction',  '_route' => 'article_index',);
            }
            not_article_index:
            ...
            if ($pathinfo === '/article/new') {
                ...
                return array (  '_controller' => 'DesguizeBundle\\Controller\\ArticleController::newAction',  '_route' => 'article_new',);
            }
            not_article_new:
            ...
            if (preg_match('#^/article/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_show')), array (  '_controller' => 'DesguizeBundle\\Controller\\ArticleController::showAction',));
            }
            not_article_show:
            ...
            if (preg_match('#^/article/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_edit')), array (  '_controller' => 'DesguizeBundle\\Controller\\ArticleController::editAction',));
            }
            not_article_edit:
            ...
            if (preg_match('#^/article/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'article_delete')), array (  '_controller' => 'DesguizeBundle\\Controller\\ArticleController::deleteAction',));
            }
            not_article_delete:
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'desguize_homepage');
            }
