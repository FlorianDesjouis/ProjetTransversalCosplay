 ...
 */
class User extends \DesguizeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'birthdate', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'postCode', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'town', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'phoneNumber', '' . "\0" . 'DesguizeBundle\\Entity\\User' . "\0" . 'photoProfile', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setPhotoProfile($photoProfile)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPhotoProfile', array($photoProfile));

        return parent::setPhotoProfile($photoProfile);
    }
    ...
    public function getPhotoProfile()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPhotoProfile', array());

        return parent::getPhotoProfile();
    }
