...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\CosplayBlogBundle\\Resources\\config\\doctrine') => 'CosplayBlogBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'CosplayBlogBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CosplayBlogBundle' => 'CosplayBlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b672df1d762a42fd3f9f0fc644efecac8dffbbd4b85b51da5aa437003995f462');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CosplayBlogBundle/Resources/views'), 'CosplayBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('afc697d7f33cb38b33c202232c1057bad7d83b56');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571101c08efc22.62527994')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CosplayBlogBundle' => 'CosplayBlogBundle\\CosplayBlogBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'projetTranversal',
            'database_user' => 'root',
            ...
            'secret' => 'afc697d7f33cb38b33c202232c1057bad7d83b56',
            'locale' => 'en',
            ...
            'kernel.secret' => 'afc697d7f33cb38b33c202232c1057bad7d83b56',
